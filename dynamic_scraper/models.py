...
class Checker(models.Model):
    ...
    scraped_obj_attr = models.ForeignKey(ScrapedObjAttr, help_text="Attribute of type DETAIL_PAGE_URL, several checkers for same DETAIL_PAGE_URL attribute possible.", on_delete=models.CASCADE)
    scraper = models.ForeignKey(Scraper, on_delete=models.CASCADE)
...
class ScraperElem(models.Model):
    ...
    scraped_obj_attr = models.ForeignKey(ScrapedObjAttr, help_text=help_text, on_delete=models.CASCADE)
    scraper = models.ForeignKey(Scraper, on_delete=models.CASCADE)
